					...
					<c:otherwise>
						<div id="reservation_content_wrapper">
							<div id="reservation_status_wrapper">
								...
								<span id="reservation_status">${upR.getStartTime().isAfter(LocalDateTime.now()) ? "예약" : "이용중"}</span>
							</div>
						...
						<div id="add1-modal-body-contents">
							...
							<div class="add1-modal-body-content">
								...
								<div id="add1-add-time-arrow-img">
									...
									<button type="button" class="add1-add-time-arrow"
										data-bs-toggle="modal" data-bs-target="#addTimeModal2"></button>
								</div>
							</div>
				...
				<div class="modal-footer">
					<div>
						<button type="button" class="submit_button add-button"
							id="add1-add-time-button" data-bs-toggle="modal"
							data-bs-target="#addTimeModal3" data-bs-dismiss="modal">
							추가하기</button>
					</div>
				</div>
			</div>
	...
	<div class="modal" id="addTimeModal2">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div id="add2-modal-body-wrapper">
						...
						<div id="add2-modal-time-setting">
							<input type="number" class="add2-time-setting-input"
								id="setting-hour" value="00" /> <span>:</span> <input
								type="number" class="add2-time-setting-input"
								id="setting-minute" value="00" />
						</div>
					</div>
				</div>
				...
				<div class="modal-footer">
					<button type="button" class="submit_button add-button"
						id="add2-add-time-button" data-bs-toggle="modal"
						data-bs-target="#addTimeModal2">설정</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal" id="addTimeModal3">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="submit_button add-button"
						id="time-setting-button" data-bs-toggle="modal"
						data-bs-target="#addTimeModal4" data-bs-dismiss="modal">
						결제</button>
				</div>
			</div>
		</div>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="submit_button add-button"
						id="add2-add-time-button" data-bs-toggle="modal"
						data-bs-dismiss="modal" data-bs-target="#cancleReservationModal2">
						취소하기</button>
				</div>
			</div>
		</div>
	...
	<div class="modal" id="cancleReservationModal2">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="cancle-modal-body-wrapper">
						<span class="cancle-modal-title">취소 완료</span> <span
							class="cancle-modal-content">예약이 취소되었습니다. 자세한 내용은 나의 예약 -
							취소 내역에서 확인해주세요.</span>
					</div>
				</div>
