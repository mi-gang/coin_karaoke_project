<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  ...
  <head>
    ...
    <link rel="stylesheet" href="css/kkFilterUI.css" />
  ...
  <body>
    ...
    <div id="mobileContainer">
        ...
        <div id="timeWrapper">
          ...
          <div class="timeItemWrapper">
            ...
            <div id="timeSettingWrapper">
              ...
              <div id="searchTimeModal1" class="modal searchTime">
          ...
          <div id="usingTimeModal" class="modal usingTime">
            <div class="modalContent">
      ...
      <nav>
        ...
        <div>
          <img src="img/searchIcon_on.svg" alt="노래방 검색 페이지" />
        </div>
        <div>
    ...
    <script>
      ...
      $("#searchKKBtn").on("click", searchKK);
      async function searchKK() {
        const searchGu = $(".label").text();
      ...
      function getOptionParameters() {
        ...
        $("#additionalOptionWrapper .optionItem").each(function (i, item) {
          if ($(item).hasClass("active")) {
            optionParameters += "&option=" + $(item).data("keywordId");
          }
        });
      ...
      function getStartDateTime() {
        ...
        const startTime = $("#hiddenTime1").val().split(":");
        ...
        if (startDateTime < now) {
          ...
          startDateTime.setDate(now.getDate());
        }
      ...
      function getEndDateTime() {
        ...
        endDateTime.setHours(parseInt(endTime[0]));
        endDateTime.setMinutes(parseInt(endTime[1]));
