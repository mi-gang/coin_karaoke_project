      ...
      <% request.getAttribute("ReservationsList"); %>
        ...
        <body>
          ...
          <div id="mobileContainer">
            <!--헤더-->
            <header>
              <img src="img/left arrow.svg" alt="이전 페이지 이동" /> <span>${kkName }</span>
            </header>
            <!-- 컨텐츠 컨테이너 -->
            <div id="container">
              <div class="infoTxt">
                ...
                <div class="roomNTimeTableContainer">
                  <c:forEach var="info" items="${infoList}" varStatus="statusInfo">
                    <div class="contents timeTable-row">
                      <div id="roomTypeName" class="roomType btn" data-room-id="${info.getRoomId()})">
                        ${info.getRoomName()}
                      ...
                      <div class="roomBox">
                        ...
                        <ul class="roomList">
                          <c:forEach var="room" items="${infoList}" varStatus="status">
                            ...
                            <li class="roomItem" data-room-id="${room.getRoomId()}">
                              ${room.getRoomName()}(${status.count})</li>
                          </c:forEach>
                        </ul>
                      </div>
                    </div>
                      ...
                      <div class="timeWrapper">
                        ...
                        <div class="timeSettingWrapper">
                          <div id="startTime" class="timeSettingItem">
                            <input id="startTimeInput" readonly placeholder="-- : --" value="" /> <img
                      ...
                      <div class="timeWrapper">
                        ...
                        <div class="timeSettingWrapper">
                          <div id="hoursOfUse" class="timeSettingItem item3">
                            <input readonly placeholder="-- : --" /> <img src="img/down_arrow.svg" alt="드롭다운" />
                          </div>
                        </div>
                      </div>
                      <div class="timeWrapper">
