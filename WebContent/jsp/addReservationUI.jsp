...
<body>
	...
	<div id="mobileContainer">
		<!--헤더-->
		<header>
			<img src="img/left arrow.svg" alt="이전 페이지 이동" /> <span>스타버스
				코인노래방</span>
		</header>
		<!-- 컨텐츠 컨테이너 -->
		<div id="container">
	...
	<div id="modal5" class="modal5Background">
		<div class="modal">
			<div class="contentsContainer">
				...
				<p class="smallTxt">
					이용 시작 <span>20분 전</span>부터는 취소 수수료가<br />부과되는 점 참고해주세요!
				</p>
