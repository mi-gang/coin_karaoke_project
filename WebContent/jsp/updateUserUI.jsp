...
<% session = request.getSession();
   ...
   UserVO user = new UserService().getUser(userId);
		...
		<div id="container">
			<form action="controller?cmd=login" method="post">
				<div id="inputField">
					...
					<div>
						<input name="nickname" id="nickname" data-original-id="<%= user.getNickname() %>"
					...
					<div>
						<input type="password" placeholder="••••••••" readonly><img
							class="editPencil" id="pwEditPencil">
					</div>
				</div>
				...
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button type="button" class="submit_button add-button"
							id="hidePasswordModal" data-bs-toggle="modal"
